...
client.connect(err => {
    ...
    const userSelectedCollection = client.db("creativeAgency").collection("userSelectedService");
    ...
    app.post('/addService', (req, res) => {
        ...
        serviceCollection.insertOne({ title: title, description: description, image })
            .then(result => {
    ...
    app.post('/serviceDetails', (req, res) => {
        ...
        userSelectedCollection.insertOne(data)
            .then(result => {
                res.send(result.acknowledged)
            })
        // const filePath = `${__dirname}/services/${file.name}`
    ...
    app.post('/makeAdmin', (req, res) => {
        ...
        adminCollection.insertOne({ adminemail: email })
            .then(result => {
                res.send(result.acknowledged)
            })
    })
    app.get('/serviseList', (req, res) => {
        ...
        adminCollection.find({ adminemail: useremail })
            .toArray((err, docoument) => {
                ...
                userSelectedCollection.find(filter)
    ...
    app.post('/serviceStatus', (req, res) => {
        ...
        userSelectedCollection.updateOne({ _id: ObjectId(serviceId) },
            {
                $set: {
    ...
    app.post('/review', (req, res) => {
        ...
        commentCollection.insertOne(data)
            .then(result => {
                res.send(result.acknowledged)
            })
    })
